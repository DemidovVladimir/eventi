...
app.get('/auth/vkontakte/callback',
    passport.authenticate('vkontakte', { successRedirect: '/success/vk',
        failureRedirect: '/loginUser' }));
app.get('/auth/google', passport.authenticate('google',{client_id: '475991763822-q8p9t2p9f143ivrep5878gdvindipc63.apps.googleusercontent.com', scope: 'https://www.googleapis.com/auth/plus.me', immediate: true}));
