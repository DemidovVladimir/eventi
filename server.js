...
passport.use(new FacebookStrategy({
        ...
        callbackURL: "http://enveti.com:8080/auth/facebook/callback"
    },
...
passport.use(new VKontakteStrategy({
        ...
        callbackURL:  "http://enveti.com:8080/auth/vkontakte/callback"
    },
    function(accessToken, refreshToken, profile, done) {
...
passport.use(new GoogleStrategy({
        ...
        callbackURL: "http://enveti.com:8080/auth/google/callback",
